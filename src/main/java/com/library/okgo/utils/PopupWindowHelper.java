...
/**
 * Created by qizfeng on 2017/12/19.
 * popupwindow帮助类
 */
...
public class PopupWindowHelper {
    ...
    public void showFromCenter(View anchor) {
        initPopupWindow(TYPE_MATCH_PARENT);
        mPopupWindow.setAnimationStyle(R.style.AnimationFromTop);
        mPopupWindow.showAtLocation(anchor, Gravity.LEFT | Gravity.CENTER, 0, getStatusBarHeight());
    }
